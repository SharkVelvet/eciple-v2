...
export default function ComparisonPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        { label: "One-Time Setup Fee", value: "$1,000" },
        { label: "Free Trial", value: "60 Day" },
        { label: "Monthly Active Users", value: "Up to 500" },
        { label: "Media Storage", value: "100 GB" },
        { label: "All Inclusive Platform", value: "✓" },
        { label: "Unlimited System Admins", value: "✓" },
        { label: "Unlimited Program Creation", value: "✓" },
        { label: "Custom Content Creation", value: "✓" },
              ...
              >
                ...
                <div className="relative h-[300px] md:h-[450px]">
                  ...
                  <div className="relative h-full">
                    ...
                    <motion.div
                      className="absolute bottom-0 left-0 bg-white/95 backdrop-blur-sm rounded-lg p-2 md:p-4 w-48 md:w-56 border border-white/30 shadow-lg text-xs md:text-sm"
                      animate={{ y: [0, -8, 0] }}
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span className="hero-button-text font-medium text-sm">See Our Solution</span>
                      <ArrowRight className="h-4 w-4 transform group-hover:translate-x-1 transition-transform" />
